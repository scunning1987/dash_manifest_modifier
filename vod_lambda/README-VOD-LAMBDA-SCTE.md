...
The Lambda will inspect the SCC XML that was submitted with the MediaConvert job and use this to add in the ad signaling information required by downstream ad insertion applications, such as MediaTailor.
